          ...
          <div>
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                I'm Ojash Osti, a dedicated software engineering student with a passion for creating elegant, efficient,
                and user-friendly applications. My journey in technology began with a curiosity about how digital
                systems work, which has evolved into a deep appreciation for software development.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                I'm currently pursuing my degree in Software Engineering at Nepal College of Information Technology
                (NCIT), where I've gained a strong foundation in computer science principles, software design patterns,
                and modern development practices. Beyond my formal education, I'm constantly expanding my knowledge
                ...
                <motion.div key={index} whileHover={{ y: -5 }} transition={{ duration: 0.3 }}>
                  <Card className="border-primary/10 hover:border-primary/30 transition-colors duration-300">
                    <CardContent className="p-4">
                      <div className={`p-2 rounded-md ${item.color} mb-3 inline-block`}>{item.icon}</div>
