...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Email",
      value: "ostiojash2061@gmail.com",
      href: "mailto:ostiojash2061@gmail.com",
  ...
  const socialLinks = [
    {
      ...
      href: "https://www.facebook.com/ojash.osti",
      label: "Facebook",
      color: "bg-blue-500/10 hover:bg-blue-500/20 text-blue-500",
    },
    {
      icon: <Instagram className="h-5 w-5" />,
      href: "https://www.instagram.com/ostiojash/",
      label: "Instagram",
      ...
      <div className="container px-4 md:px-6">
        ...
        >
          <Badge variant="outline" className="px-4 py-1 mb-4 border-primary/20 text-primary">
            <MessageSquare className="mr-1 h-3 w-3" /> Let's Connect
          </Badge>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <motion.div style={{ y, opacity }} className="space-y-8">
              ...
              <div className="space-y-6 mb-8">
                {contactInfo.map((item, index) => (
                  <motion.a
                    key={index}
                    href={item.href}
                    className="flex items-start hover:text-primary transition-colors p-4 rounded-lg hover:bg-muted/50"
                    whileHover={{ x: 5 }}
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className={`p-4 rounded-full ${social.color} transition-all duration-300`}
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="mt-8 p-6 bg-muted/30 rounded-lg border border-primary/10"
            >
              <h4 className="text-xl font-bold mb-4">Let's Work Together</h4>
              <p className="text-muted-foreground mb-4">
                I'm currently available for freelance work and internship opportunities. If you have a project that you
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className={`${errors.name ? "border-red-500" : "border-input"} focus:border-primary transition-colors`}
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={handleChange}
                        className={`${errors.email ? "border-red-500" : "border-input"} focus:border-primary transition-colors`}
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        onChange={handleChange}
                        className={`${errors.message ? "border-red-500" : "border-input"} focus:border-primary transition-colors`}
                      />
